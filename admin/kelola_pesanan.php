                                          ...
                                          <table class="table bg-white rounded shadow-sm table-hover">
                                                <thead>
                                                      <tr>
                                                            ...
                                                            <th scope="col" width="200">Aksi</th>                                                       </tr>
                                                </thead>
                                                <tbody>
                                                            ...
                                                            <?php foreach ($bookings as $booking): ?>
                                                                  <tr>
                                                                        ...
                                                                        <td>
                                                                                    ...
                                                                                    <a href="cetak_struk.php?booking_id=<?= $booking['id'] ?>" target="_blank" class="btn btn-sm btn-info text-white mt-1 mt-md-0">
